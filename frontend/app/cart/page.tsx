      ...
      <main style={{ position: 'relative', zIndex: 10, padding: '16px' }}>
        ...
        {isEmpty ? (
          <div style={{ minHeight: '60vh', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
            <EmptyState
              icon={<ShoppingBag style={{ width: 32, height: 32 }} strokeWidth={1.5} />}
              title="Корзина пуста"
              subtitle="Добавьте товары из магазинов, чтобы оформить заказ"
              action={{ label: 'Перейти к магазинам', onClick: () => router.push('/') }}
            />
          </div>
        ) : (
          // Товары в корзине
